...
data_cleaned <- subset(czynniki, Exam_Score <= 100)
...
LICZBA_NA2
```
Reszte zmiennych postanawiamy zastąpić przy użyciu metody mice. Która będzie najlepsza wobec zastąpywania brakujących wartości dla naszych danych
```{r}
