...
statystyki_t <- t(statystyki)

# Konwertowanie tabeli na data.frame
statystyki_t <- as.data.frame(statystyki_t)

# Dodanie nazwy kolumny dla wartości
colnames(statystyki_t) <- c("Wartości")

# Przypisujemy statystyki do odpowiedniej kolumny
statystyki_t$Statystyki <- rownames(statystyki_t)

# Zmieniamy kolejność kolumn
statystyki_t <- statystyki_t[, c("Statystyki", "Wartości")]
